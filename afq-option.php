 ...
 *   [afq_voice_grid]         نظرات مشتریان (count, columns)
 *   [afq_circular_cars]      خودروهای بخش‌نامه (id)
 *   [afq_signup_form]        فرم ثبت‌نام (types, type)
 *   [afq_request_form]       فرم صدای مشتری
 *   [afq_request_track]      فرم پیگیری درخواست
 *   [afq_flipbook]           نمایش PDF به‌صورت کتاب ورق‌خور (url, id, title, dir, spread, height, start, download)
 *
...
define( 'AFQ_OPTION_VERSION', '1.1.0' );
...
/* Bundled Mozilla PDF.js (Apache-2.0) — see assets/vendor/pdfjs/LICENSE. */
define( 'AFQ_PDFJS_VERSION', '3.11.174' );
